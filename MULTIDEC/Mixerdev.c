/*********************************************************************************
 *                                                                               *
 * Mixerdev.c: Ansteuerung MixerDevice                                           *
 *                                                                               *
...
void Enumerate_Sound_SubSystem(void)
{
	...
	if ( SoundSystem.DeviceAnzahl == 0 ) return;
        ...
        mmresult = mixerGetLineInfo((HMIXEROBJ)hMixer,&SoundSystem.To_Lines[SoundSystemLoop].MixerLine[DestinationLoop],MIXER_GETLINEINFOF_DESTINATION);
		  if ( mmresult == MMSYSERR_NOERROR ) {
            // Enumerate Connection
			  ...
			  SoundSystem.To_Lines[SoundSystemLoop].To_Connection[DestinationLoop].MixerConnections=(MIXERLINE *)calloc(sizeof(MIXERLINE),SoundSystem.To_Lines[SoundSystemLoop].MixerLine[DestinationLoop].cConnections);
			  SoundSystem.To_Lines[SoundSystemLoop].To_Connection[DestinationLoop].To_Control=(struct TMixerControls *)calloc(sizeof(struct TMixerConnections),SoundSystem.To_Lines[SoundSystemLoop].MixerLine[DestinationLoop].cConnections);
               for (ConnectionLoop=0; ConnectionLoop < SoundSystem.To_Lines[SoundSystemLoop].To_Connection[DestinationLoop].AnzahlConnections; ConnectionLoop++) {
					...
					mmresult = mixerGetLineInfo((HMIXEROBJ)hMixer,&SoundSystem.To_Lines[SoundSystemLoop].To_Connection[DestinationLoop].MixerConnections[ConnectionLoop],MIXER_GETLINEINFOF_SOURCE);
		  if ( mmresult == MMSYSERR_NOERROR ) {
            // Enumerate Controls
			  
                    SoundSystem.To_Lines[SoundSystemLoop].To_Connection[DestinationLoop].To_Control[ConnectionLoop].AnzahlControls=SoundSystem.To_Lines[SoundSystemLoop].MixerLine[DestinationLoop].cControls;
                    SoundSystem.To_Lines[SoundSystemLoop].To_Connection[DestinationLoop].To_Control[ConnectionLoop].MixerControl=(MIXERCONTROL *)calloc(sizeof(MIXERCONTROL),SoundSystem.To_Lines[SoundSystemLoop].To_Connection[DestinationLoop].To_Control[ConnectionLoop].AnzahlControls);
                    SoundSystem.To_Lines[SoundSystemLoop].To_Connection[DestinationLoop].To_Control[ConnectionLoop].MixerDetail=(MIXERCONTROLDETAILS  *)calloc(sizeof(MIXERCONTROLDETAILS),SoundSystem.To_Lines[SoundSystemLoop].To_Connection[DestinationLoop].To_Control[ConnectionLoop].AnzahlControls);
...
/***************************/
                  ...
                  switch ( SoundSystem.To_Lines[SoundSystemLoop].To_Connection[DestinationLoop].To_Control[ConnectionLoop].MixerControl[ControlLoop].dwControlType&MIXERCONTROL_CT_UNITS_MASK)
							{
                           case MIXERCONTROL_CT_UNITS_BOOLEAN:
	                                SoundSystem.To_Lines[SoundSystemLoop].To_Connection[DestinationLoop].To_Control[ConnectionLoop].MixerDetail[ControlLoop].cbDetails      = sizeof( MIXERCONTROLDETAILS_BOOLEAN );
									SoundSystem.To_Lines[SoundSystemLoop].To_Connection[DestinationLoop].To_Control[ConnectionLoop].MixerDetail[ControlLoop].paDetails      = ( MIXERCONTROLDETAILS_BOOLEAN *)calloc(sizeof( MIXERCONTROLDETAILS_BOOLEAN ),MAXKANAELE);
							break;
						   case MIXERCONTROL_CT_UNITS_SIGNED:
									SoundSystem.To_Lines[SoundSystemLoop].To_Connection[DestinationLoop].To_Control[ConnectionLoop].MixerDetail[ControlLoop].cbDetails      = sizeof( MIXERCONTROLDETAILS_SIGNED );
									SoundSystem.To_Lines[SoundSystemLoop].To_Connection[DestinationLoop].To_Control[ConnectionLoop].MixerDetail[ControlLoop].paDetails      = ( MIXERCONTROLDETAILS_SIGNED *)calloc(sizeof( MIXERCONTROLDETAILS_SIGNED ),MAXKANAELE);
							break;
						   case MIXERCONTROL_CT_UNITS_UNSIGNED:
									SoundSystem.To_Lines[SoundSystemLoop].To_Connection[DestinationLoop].To_Control[ConnectionLoop].MixerDetail[ControlLoop].cbDetails      = sizeof( MIXERCONTROLDETAILS_UNSIGNED );
									SoundSystem.To_Lines[SoundSystemLoop].To_Connection[DestinationLoop].To_Control[ConnectionLoop].MixerDetail[ControlLoop].paDetails      = ( MIXERCONTROLDETAILS_UNSIGNED *)calloc(sizeof( MIXERCONTROLDETAILS_UNSIGNED ),MAXKANAELE);
							break;
							}
                  ...
                  while ( KanalLoop > 0 ) {
						 ...
						 SoundSystem.To_Lines[SoundSystemLoop].To_Connection[DestinationLoop].To_Control[ConnectionLoop].MixerDetail[ControlLoop].dwControlID    = SoundSystem.To_Lines[SoundSystemLoop].To_Connection[DestinationLoop].To_Control[ConnectionLoop].MixerControl[ControlLoop].dwControlID;
                         ...
                         if ( Get_Control_Values(&SoundSystem.To_Lines[SoundSystemLoop].To_Connection[DestinationLoop].To_Control[ConnectionLoop].MixerDetail[ControlLoop],SoundSystemLoop) == ERROR_SUCCESS ) {
                             KanalLoop=0;
			...
			case MIXERCONTROL_CONTROLTYPE_ONOFF:
											 if ( SoundSystem.To_Lines[SoundSystemLoop].To_Connection[DestinationLoop].To_Control[ConnectionLoop].MixerControl[ControlLoop].szName[0] == 0x00 ) {
			                                	 strcpy(&SoundSystem.To_Lines[SoundSystemLoop].To_Connection[DestinationLoop].To_Control[ConnectionLoop].MixerControl[ControlLoop].szName[0],"ONOFF ID gefunden");
											 };
                                    break;
            case MIXERCONTROL_CONTROLTYPE_MONO:           
											 if ( SoundSystem.To_Lines[SoundSystemLoop].To_Connection[DestinationLoop].To_Control[ConnectionLoop].MixerControl[ControlLoop].szName[0] == 0x00 ) {
												strcpy(&SoundSystem.To_Lines[SoundSystemLoop].To_Connection[DestinationLoop].To_Control[ConnectionLoop].MixerControl[ControlLoop].szName[0],"MONO ID gefunden");
											 };
                                    break;
            case MIXERCONTROL_CONTROLTYPE_LOUDNESS:       				
											 if ( SoundSystem.To_Lines[SoundSystemLoop].To_Connection[DestinationLoop].To_Control[ConnectionLoop].MixerControl[ControlLoop].szName[0] == 0x00 ) {
												strcpy(&SoundSystem.To_Lines[SoundSystemLoop].To_Connection[DestinationLoop].To_Control[ConnectionLoop].MixerControl[ControlLoop].szName[0],"LOUDNESS ID gefunden");
											};
									break;
			
			case MIXERCONTROL_CONTROLTYPE_STEREOENH:      
											 if ( SoundSystem.To_Lines[SoundSystemLoop].To_Connection[DestinationLoop].To_Control[ConnectionLoop].MixerControl[ControlLoop].szName[0] == 0x00 ) {
												strcpy(&SoundSystem.To_Lines[SoundSystemLoop].To_Connection[DestinationLoop].To_Control[ConnectionLoop].MixerControl[ControlLoop].szName[0],"STEREOENH ID gefunden");
											 };
									break;
			
			case MIXERCONTROL_CONTROLTYPE_BUTTON:     
											 if ( SoundSystem.To_Lines[SoundSystemLoop].To_Connection[DestinationLoop].To_Control[ConnectionLoop].MixerControl[ControlLoop].szName[0] == 0x00 ) {
												strcpy(&SoundSystem.To_Lines[SoundSystemLoop].To_Connection[DestinationLoop].To_Control[ConnectionLoop].MixerControl[ControlLoop].szName[0],"BUTTON ID gefunden");
											 };
									break;
			
			case MIXERCONTROL_CONTROLTYPE_DECIBELS:       
											 if ( SoundSystem.To_Lines[SoundSystemLoop].To_Connection[DestinationLoop].To_Control[ConnectionLoop].MixerControl[ControlLoop].szName[0] == 0x00 ) {
												strcpy(&SoundSystem.To_Lines[SoundSystemLoop].To_Connection[DestinationLoop].To_Control[ConnectionLoop].MixerControl[ControlLoop].szName[0],"DECIBELS ID gefunden");
											 };
									break;
			case MIXERCONTROL_CONTROLTYPE_SIGNED:         
											 if ( SoundSystem.To_Lines[SoundSystemLoop].To_Connection[DestinationLoop].To_Control[ConnectionLoop].MixerControl[ControlLoop].szName[0] == 0x00 ) {
												strcpy(&SoundSystem.To_Lines[SoundSystemLoop].To_Connection[DestinationLoop].To_Control[ConnectionLoop].MixerControl[ControlLoop].szName[0],"SIGNED ID gefunden");
											 };
									break;
			case MIXERCONTROL_CONTROLTYPE_UNSIGNED:       
											 if ( SoundSystem.To_Lines[SoundSystemLoop].To_Connection[DestinationLoop].To_Control[ConnectionLoop].MixerControl[ControlLoop].szName[0] == 0x00 ) {
												strcpy(&SoundSystem.To_Lines[SoundSystemLoop].To_Connection[DestinationLoop].To_Control[ConnectionLoop].MixerControl[ControlLoop].szName[0],"UNSIGNED ID gefunden");
											 };
									break;
			case MIXERCONTROL_CONTROLTYPE_PERCENT:        
											 if ( SoundSystem.To_Lines[SoundSystemLoop].To_Connection[DestinationLoop].To_Control[ConnectionLoop].MixerControl[ControlLoop].szName[0] == 0x00 ) {
												strcpy(&SoundSystem.To_Lines[SoundSystemLoop].To_Connection[DestinationLoop].To_Control[ConnectionLoop].MixerControl[ControlLoop].szName[0],"PERCENT ID gefunden");
											 };
									break;
			case MIXERCONTROL_CONTROLTYPE_SLIDER:         
											 if ( SoundSystem.To_Lines[SoundSystemLoop].To_Connection[DestinationLoop].To_Control[ConnectionLoop].MixerControl[ControlLoop].szName[0] == 0x00 ) {
												strcpy(&SoundSystem.To_Lines[SoundSystemLoop].To_Connection[DestinationLoop].To_Control[ConnectionLoop].MixerControl[ControlLoop].szName[0],"SLIDER ID gefunden");
											 };
									break;
			case MIXERCONTROL_CONTROLTYPE_PAN:            
											 if ( SoundSystem.To_Lines[SoundSystemLoop].To_Connection[DestinationLoop].To_Control[ConnectionLoop].MixerControl[ControlLoop].szName[0] == 0x00 ) {
												strcpy(&SoundSystem.To_Lines[SoundSystemLoop].To_Connection[DestinationLoop].To_Control[ConnectionLoop].MixerControl[ControlLoop].szName[0],"PAN ID gefunden");
											 };
									break;
			case MIXERCONTROL_CONTROLTYPE_QSOUNDPAN:      
											 if ( SoundSystem.To_Lines[SoundSystemLoop].To_Connection[DestinationLoop].To_Control[ConnectionLoop].MixerControl[ControlLoop].szName[0] == 0x00 ) {
												strcpy(&SoundSystem.To_Lines[SoundSystemLoop].To_Connection[DestinationLoop].To_Control[ConnectionLoop].MixerControl[ControlLoop].szName[0],"QSOUNDPAN ID gefunden");
											 };
									break;

			case MIXERCONTROL_CONTROLTYPE_FADER:          
											 if ( SoundSystem.To_Lines[SoundSystemLoop].To_Connection[DestinationLoop].To_Control[ConnectionLoop].MixerControl[ControlLoop].szName[0] == 0x00 ) {
												strcpy(&SoundSystem.To_Lines[SoundSystemLoop].To_Connection[DestinationLoop].To_Control[ConnectionLoop].MixerControl[ControlLoop].szName[0],"FADER ID gefunden");
											 };
									break;

			case MIXERCONTROL_CONTROLTYPE_BASS:           
											 if ( SoundSystem.To_Lines[SoundSystemLoop].To_Connection[DestinationLoop].To_Control[ConnectionLoop].MixerControl[ControlLoop].szName[0] == 0x00 ) {
												strcpy(&SoundSystem.To_Lines[SoundSystemLoop].To_Connection[DestinationLoop].To_Control[ConnectionLoop].MixerControl[ControlLoop].szName[0],"BASS ID gefunden");
											 };
									break;

			case MIXERCONTROL_CONTROLTYPE_TREBLE:         
											 if ( SoundSystem.To_Lines[SoundSystemLoop].To_Connection[DestinationLoop].To_Control[ConnectionLoop].MixerControl[ControlLoop].szName[0] == 0x00 ) {
												strcpy(&SoundSystem.To_Lines[SoundSystemLoop].To_Connection[DestinationLoop].To_Control[ConnectionLoop].MixerControl[ControlLoop].szName[0],"TREBLE ID gefunden");
											 };
									break;

			case MIXERCONTROL_CONTROLTYPE_EQUALIZER:      
											 if ( SoundSystem.To_Lines[SoundSystemLoop].To_Connection[DestinationLoop].To_Control[ConnectionLoop].MixerControl[ControlLoop].szName[0] == 0x00 ) {
												strcpy(&SoundSystem.To_Lines[SoundSystemLoop].To_Connection[DestinationLoop].To_Control[ConnectionLoop].MixerControl[ControlLoop].szName[0],"EQUALIZER ID gefunden");
											 };
									break;

			case MIXERCONTROL_CONTROLTYPE_SINGLESELECT:   
											 if ( SoundSystem.To_Lines[SoundSystemLoop].To_Connection[DestinationLoop].To_Control[ConnectionLoop].MixerControl[ControlLoop].szName[0] == 0x00 ) {
												strcpy(&SoundSystem.To_Lines[SoundSystemLoop].To_Connection[DestinationLoop].To_Control[ConnectionLoop].MixerControl[ControlLoop].szName[0],"SINGLESELECT ID gefunden");
											 };
									break;

			case MIXERCONTROL_CONTROLTYPE_MUX:            
											 if ( SoundSystem.To_Lines[SoundSystemLoop].To_Connection[DestinationLoop].To_Control[ConnectionLoop].MixerControl[ControlLoop].szName[0] == 0x00 ) {
												strcpy(&SoundSystem.To_Lines[SoundSystemLoop].To_Connection[DestinationLoop].To_Control[ConnectionLoop].MixerControl[ControlLoop].szName[0],"MUX ID gefunden");
											 };
									break;

			case MIXERCONTROL_CONTROLTYPE_MULTIPLESELECT: 
											 if ( SoundSystem.To_Lines[SoundSystemLoop].To_Connection[DestinationLoop].To_Control[ConnectionLoop].MixerControl[ControlLoop].szName[0] == 0x00 ) {
												strcpy(&SoundSystem.To_Lines[SoundSystemLoop].To_Connection[DestinationLoop].To_Control[ConnectionLoop].MixerControl[ControlLoop].szName[0],"MULTIPLESELECT ID gefunden");
											 };
									break;

			case MIXERCONTROL_CONTROLTYPE_MIXER:          
											 if ( SoundSystem.To_Lines[SoundSystemLoop].To_Connection[DestinationLoop].To_Control[ConnectionLoop].MixerControl[ControlLoop].szName[0] == 0x00 ) {
												strcpy(&SoundSystem.To_Lines[SoundSystemLoop].To_Connection[DestinationLoop].To_Control[ConnectionLoop].MixerControl[ControlLoop].szName[0],"MIXER ID gefunden");
											 };
									break;

			case MIXERCONTROL_CONTROLTYPE_MICROTIME:      
											 if ( SoundSystem.To_Lines[SoundSystemLoop].To_Connection[DestinationLoop].To_Control[ConnectionLoop].MixerControl[ControlLoop].szName[0] == 0x00 ) {
												strcpy(&SoundSystem.To_Lines[SoundSystemLoop].To_Connection[DestinationLoop].To_Control[ConnectionLoop].MixerControl[ControlLoop].szName[0],"MICROTIME ID gefunden");
											 };
									break;

			case MIXERCONTROL_CONTROLTYPE_MILLITIME:      
											 if ( SoundSystem.To_Lines[SoundSystemLoop].To_Connection[DestinationLoop].To_Control[ConnectionLoop].MixerControl[ControlLoop].szName[0] == 0x00 ) {
												strcpy(&SoundSystem.To_Lines[SoundSystemLoop].To_Connection[DestinationLoop].To_Control[ConnectionLoop].MixerControl[ControlLoop].szName[0],"MILLITIME ID gefunden");
											 };
									break;
		    ...
		    case MIXERCONTROL_CONTROLTYPE_MUTE:
										     if ( Mute.SoundSystem == -1 ) {
												 if ( SoundSystem.To_Lines[SoundSystemLoop].MixerLine[DestinationLoop].dwComponentType == MIXERLINE_COMPONENTTYPE_DST_SPEAKERS ) {
													 if (( SoundSystem.To_Lines[SoundSystemLoop].To_Connection[DestinationLoop].MixerConnections[ConnectionLoop].dwComponentType == MIXERLINE_COMPONENTTYPE_SRC_LINE ) ||
													    ( SoundSystem.To_Lines[SoundSystemLoop].To_Connection[DestinationLoop].MixerConnections[ConnectionLoop].dwComponentType ==  MIXERLINE_COMPONENTTYPE_SRC_AUXILIARY )) {
				                         ...
				                         if ( SoundSystem.To_Lines[SoundSystemLoop].To_Connection[DestinationLoop].To_Control[ConnectionLoop].MixerControl[ControlLoop].szName[0] == 0x00 ) {
												strcpy(SoundSystem.To_Lines[SoundSystemLoop].To_Connection[DestinationLoop].To_Control[ConnectionLoop].MixerControl[ControlLoop].szName,"MUTE ID gefunden");
											 };
									break;
          ...
          case MIXERCONTROL_CONTROLTYPE_VOLUME:
											 ...
											 if ( SoundSystem.To_Lines[SoundSystemLoop].To_Connection[DestinationLoop].To_Control[ConnectionLoop].MixerControl[ControlLoop].szName[0] == 0x00 ) {
												strcpy(&SoundSystem.To_Lines[SoundSystemLoop].To_Connection[DestinationLoop].To_Control[ConnectionLoop].MixerControl[ControlLoop].szName[0],"VOLUME ID gefunden");
											 };
									break;

         }
 } else {
if ( KanalLoop == 0 ) strcpy(SoundSystem.To_Lines[SoundSystemLoop].To_Connection[DestinationLoop].To_Control[ConnectionLoop].MixerControl[ControlLoop].szName,"Nicht ladbar");
};  
 KanalLoop--;
}
}
...
for (DestinationLoop=0; DestinationLoop < SoundSystem.To_Lines[SoundSystemLoop].AnzahlLines; DestinationLoop++) {
			  ...
			  for (ConnectionLoop=0; ConnectionLoop < SoundSystem.To_Lines[SoundSystemLoop].To_Connection[DestinationLoop].AnzahlConnections; ConnectionLoop++) {
					for (ControlLoop=0; ControlLoop < SoundSystem.To_Lines[SoundSystemLoop].To_Connection[DestinationLoop].To_Control[ConnectionLoop].AnzahlControls; ControlLoop++) {
						if (SoundSystem.To_Lines[SoundSystemLoop].To_Connection[DestinationLoop].To_Control[ConnectionLoop].MixerDetail[ControlLoop].paDetails != NULL ) free(SoundSystem.To_Lines[SoundSystemLoop].To_Connection[DestinationLoop].To_Control[ConnectionLoop].MixerDetail[ControlLoop].paDetails);
					};     
                    if ( SoundSystem.To_Lines[SoundSystemLoop].To_Connection[DestinationLoop].To_Control[ConnectionLoop].MixerControl != NULL ) free(SoundSystem.To_Lines[SoundSystemLoop].To_Connection[DestinationLoop].To_Control[ConnectionLoop].MixerControl);
                    if ( SoundSystem.To_Lines[SoundSystemLoop].To_Connection[DestinationLoop].To_Control[ConnectionLoop].MixerDetail != NULL ) free(SoundSystem.To_Lines[SoundSystemLoop].To_Connection[DestinationLoop].To_Control[ConnectionLoop].MixerDetail);
			  };

	          if ( SoundSystem.To_Lines[SoundSystemLoop].To_Connection[DestinationLoop].MixerConnections != NULL ) free(SoundSystem.To_Lines[SoundSystemLoop].To_Connection[DestinationLoop].MixerConnections);
      		  if ( SoundSystem.To_Lines[SoundSystemLoop].To_Connection[DestinationLoop].To_Control != NULL ) free(SoundSystem.To_Lines[SoundSystemLoop].To_Connection[DestinationLoop].To_Control);
		}
	 if ( SoundSystem.To_Lines[SoundSystemLoop].MixerLine != NULL ) free(SoundSystem.To_Lines[SoundSystemLoop].MixerLine);
     if ( SoundSystem.To_Lines[SoundSystemLoop].To_Connection != NULL ) free(SoundSystem.To_Lines[SoundSystemLoop].To_Connection);
}
if ( SoundSystem.MixerDev != NULL ) free(SoundSystem.MixerDev);
if ( SoundSystem.To_Lines != NULL ) free(SoundSystem.To_Lines);
};
...
MMRESULT Set_Control_Values( MIXERCONTROLDETAILS *Setting ,int Device )
{
if ( SoundSystem.DeviceAnzahl == 0 ) return(-1);
...
MixerVolumeStep=-1;
if ( SoundSystem.DeviceAnzahl == 0 ) return;
if ( Volume.SoundSystem < 0 ) return;
...
Set_Mixer_UnsignedValue(&SoundSystem.To_Lines[MixerLoad[i].MixerAccess.SoundSystem].To_Connection[MixerLoad[i].MixerAccess.Destination].To_Control[MixerLoad[i].MixerAccess.Connection].MixerDetail[MixerLoad[i].MixerAccess.Control],MixerLoad[i].MixerAccess.SoundSystem,UnsignedWert);
	};
};
};
...
int Get_Access_Slot(int C1,int C2, int C3, int C4)
{
	int i;
					    i=0;
						while ( i < 64 ) {
							if (( MixerLoad[i].MixerAccess.SoundSystem == C1 ) &&
								( MixerLoad[i].MixerAccess.Destination == C2 ) &&
								( MixerLoad[i].MixerAccess.Connection == C3 ) &&
								( MixerLoad[i].MixerAccess.Control == C4 )) return(i);
							i++ ;
						}
return(-1);
}

BOOL APIENTRY MixerSetupProc
(
    HWND hDlg,
    UINT message,
    UINT wParam,
...
double d;
	...
	switch (message) {
        ...
        case WM_USER:
			...
			if ( Volume.SoundSystem >= 0 ) {
             sprintf(Text,"%s",SoundSystem.MixerDev[Volume.SoundSystem].szPname);
			  ...
			  if ( Volume.SoundSystem >= 0 ) {
				 sprintf(Text,"%s -> %s  %s",SoundSystem.To_Lines[Volume.SoundSystem].To_Connection[Volume.Destination].MixerConnections[Volume.Connection].szName,SoundSystem.To_Lines[Volume.SoundSystem].MixerLine[Volume.Destination].szName,SoundSystem.To_Lines[Volume.SoundSystem].To_Connection[Volume.Destination].To_Control[Volume.Connection].MixerControl[Volume.Control].szName);
			     SetDlgItemText(hDlg,TEXT2,Text); 
			  } else SetDlgItemText(hDlg,TEXT2,"Volume nicht zugeordnet");
			 ...
			 } else SetDlgItemText(hDlg,TEXT2,"Mute nicht zugeordnet");
        ...
        case WM_MOUSEMOVE:
                  if ( Volume.SoundSystem < 0 ) break;
				  if ( SoundSystem.DeviceAnzahl == 0 ) break;
                  y=HIWORD( lParam );
			      x=LOWORD( lParam );
				...
				if (( y >= 75) && ( y <= 235 )) {
					...
					if (( x >= 331 ) && ( x <= 356 )) {
						...
						j=MIXER_MITTE-i;
						j=-j;
						if (( j+MIXER_LINKER_KANAL <= MixerVolumeMax ) && 
							( j+MIXER_RECHTER_KANAL <= MixerVolumeMax ) && 
							( j+MIXER_LINKER_KANAL >= 0 ) &&
							( j+MIXER_RECHTER_KANAL >= 0 )) {
						MoveWindow(GetDlgItem(hDlg,IDC_S3),333,y-2,22,8,TRUE);
		...
		case WM_COMMAND:
            ...
            case IDC_CHECK2:
				if (IsDlgButtonChecked(hDlg, IDC_CHECK2)) {
					if ( SoundSystem.DeviceAnzahl == 0 ) Enumerate_Sound_SubSystem();
...
BOOL APIENTRY MixerSettingProc
(
    HWND hDlg,
    UINT message,
    UINT wParam,
...
case WM_USER:
	...
	if ( wParam == 4 ) {
		   ...
		   Has_Changed=TRUE;
		   if ( strcmp(Text,Text1) == 0 ) Has_Changed=FALSE;
		   ...
		   if ( Get_Access_Slot(C1,C2,C3,C4) >= 0 ) CheckDlgButton(hDlg, IDC_CHECK1, TRUE); 
		   }; 
		   ...
		   switch ( SoundSystem.To_Lines[C1].To_Connection[C2].To_Control[C3].MixerControl[C4].dwControlType&MIXERCONTROL_CT_UNITS_MASK)
					{
					 case MIXERCONTROL_CT_UNITS_BOOLEAN:
						 ...
						 if ( BoolWert[0].fValue == 1) SetDlgItemText(hDlg,TEXT12,(LPSTR)"TRUE");
						   else SetDlgItemText(hDlg,TEXT12,(LPSTR)"FALSE");
                         ...
                         if ( BoolWert[1].fValue == 1) SetDlgItemText(hDlg,TEXT13,(LPSTR)"TRUE");
						   else SetDlgItemText(hDlg,TEXT13,(LPSTR)"FALSE");
						   }
                         ...
                         if ( BoolWert[2].fValue == 1) SetDlgItemText(hDlg,TEXT14,(LPSTR)"TRUE");
						   else SetDlgItemText(hDlg,TEXT14,(LPSTR)"FALSE");
						   }
						 ...
						 if ( BoolWert[3].fValue == 1) SetDlgItemText(hDlg,TEXT15,(LPSTR)"TRUE");
						   else SetDlgItemText(hDlg,TEXT15,(LPSTR)"FALSE");
						   }
  ...
  if ( wParam == 5 ) {
		...
		case WM_COMMAND:
			...
			case IDC_COMBO1:
                     if ( HIWORD( wParam ) == CBN_SELCHANGE  ) SendMessage(hDlg,WM_USER,1,0);
                     break;
			case IDC_COMBO2:
                     if ( HIWORD( wParam ) == CBN_SELCHANGE  ) SendMessage(hDlg,WM_USER,2,0);
                     break;
			case IDC_COMBO3:
                     if ( HIWORD( wParam ) == CBN_SELCHANGE  ) SendMessage(hDlg,WM_USER,3,0);
                     break;
			case IDC_COMBO4:
                     if ( HIWORD( wParam ) == CBN_SELCHANGE  ) SendMessage(hDlg,WM_USER,4,0);
                     break;
			...
			case IDC_CHECK1:
				...
				if (IsDlgButtonChecked(hDlg, IDC_CHECK1)) {
						...
						if ( i < 0 ) {
							i=0;
						while ( i < 64 ) {
							if ( MixerLoad[i].MixerAccess.SoundSystem == -1 ) break;
							i++ ;
						}
						}

						if ( i >= 64 ) {
							MessageBox(hDlg,"Alle Default-Slots voll","Multi-Dec",MB_ICONSTOP|MB_OK);
                            return(TRUE);
						}
				...
				if ( HIWORD( wParam ) == LBN_SELCHANGE  ) {
                       ...
                       if ( strncmp(Text,"Volume-",7) == 0 ) {
            				if ((( Volume.SoundSystem >= 0 ) && ( Volume.SoundSystem < SoundSystem.DeviceAnzahl )) &&
								...
								MessageBox(hDlg,"Volume-Control fehlerhaft zugeordnet","Multi-Dec",MB_ICONSTOP|MB_OK);
							}
            				...
            				if ((( Mute.SoundSystem >= 0 ) && ( Mute.SoundSystem < SoundSystem.DeviceAnzahl )) &&
								...
								MessageBox(hDlg,"Mute-Control fehlerhaft zugeordnet","Multi-Dec",MB_ICONSTOP|MB_OK);
							} 
            				...
            				if ((( MixerLoad[i].MixerAccess.SoundSystem >= 0 ) && ( MixerLoad[i].MixerAccess.SoundSystem < SoundSystem.DeviceAnzahl )) &&
                			    ...
                			    (( MixerLoad[i].MixerAccess.Connection >= 0 ) &&  ( MixerLoad[i].MixerAccess.Connection < SoundSystem.To_Lines[MixerLoad[i].MixerAccess.SoundSystem].To_Connection[MixerLoad[i].MixerAccess.Destination].AnzahlConnections )) &&
								(( MixerLoad[i].MixerAccess.Control >= 0 ) && ( MixerLoad[i].MixerAccess.Control < SoundSystem.To_Lines[MixerLoad[i].MixerAccess.SoundSystem].To_Connection[MixerLoad[i].MixerAccess.Destination].To_Control[MixerLoad[i].MixerAccess.Connection].AnzahlControls ))) {
								...
								MessageBox(hDlg,"Startup-Control fehlerhaft zugeordnet","Multi-Dec",MB_ICONSTOP|MB_OK);
							}
								}
							}
            ...
            case IDC_BUTTON1:
					   ...
					   C4=SendMessage(GetDlgItem(hDlg,IDC_COMBO4),CB_GETCURSEL,0,0);
						 Get_Mixer_BoolValue(&SoundSystem.To_Lines[C1].To_Connection[C2].To_Control[C3].MixerDetail[C4],C1,BoolWert);
                         if ( BoolWert[0].fValue == 1 )  BoolWert[0].fValue = 0;
						      else BoolWert[0].fValue = 1;
            ...
            case IDC_BUTTON4:
					   ...
					   C4=SendMessage(GetDlgItem(hDlg,IDC_COMBO4),CB_GETCURSEL,0,0);
						 Get_Mixer_BoolValue(&SoundSystem.To_Lines[C1].To_Connection[C2].To_Control[C3].MixerDetail[C4],C1,BoolWert);
                         if ( BoolWert[1].fValue == 1 )  BoolWert[1].fValue = 0;
						      else BoolWert[1].fValue = 1;
                         Set_Mixer_BoolValue(&SoundSystem.To_Lines[C1].To_Connection[C2].To_Control[C3].MixerDetail[C4],C1,BoolWert);
						 break;
			...
			case IDC_BUTTON7:
					   ...
					   C4=SendMessage(GetDlgItem(hDlg,IDC_COMBO4),CB_GETCURSEL,0,0);
						 Get_Mixer_BoolValue(&SoundSystem.To_Lines[C1].To_Connection[C2].To_Control[C3].MixerDetail[C4],C1,BoolWert);
                         if ( BoolWert[2].fValue == 1 )  BoolWert[2].fValue = 0;
						      else BoolWert[2].fValue = 1;
                         Set_Mixer_BoolValue(&SoundSystem.To_Lines[C1].To_Connection[C2].To_Control[C3].MixerDetail[C4],C1,BoolWert);
						 break;
            ...
            case IDC_BUTTON10:
					   ...
					   C4=SendMessage(GetDlgItem(hDlg,IDC_COMBO4),CB_GETCURSEL,0,0);
						 Get_Mixer_BoolValue(&SoundSystem.To_Lines[C1].To_Connection[C2].To_Control[C3].MixerDetail[C4],C1,BoolWert);
                         if ( BoolWert[3].fValue == 1 )  BoolWert[3].fValue = 0;
						      else BoolWert[3].fValue = 1;
                         Set_Mixer_BoolValue(&SoundSystem.To_Lines[C1].To_Connection[C2].To_Control[C3].MixerDetail[C4],C1,BoolWert);
						 break;
